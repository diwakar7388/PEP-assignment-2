...
function Counter() {
  ...
  return (
    <div className="main">
      ...
      <div className="Card">
        <Label className="Count" size="huge">
          Count{" "}
        </Label>
        <Label className="CountNumber" size="huge">
          {count}
        </Label>
        <Button.Group>
          <Button className="increment" onClick={IncrementFn}>
            {" "}
            Increment{" "}
          </Button>
          <Button className={buttonClass} onClick={DecrementFn}>
            Decrement{" "}
          </Button>
        </Button.Group>
      </div>
      <p onMouseOver={social} className="credit">
        <span></span>
      </p>
    </div>
  );
